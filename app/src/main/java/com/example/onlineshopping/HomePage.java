...
//        User prefUser = gson.fromJson(json, User.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.nav_signout:
                confirmSignOut();
                break;
            case R.id.nav_aboute: // Add case for About item
                // Open About page here
                openAboutPage();
                break;
            case R.id.nav_media: // Add case for Media item
                openMediaPage();
                break;
        }
    ...
    private void openMediaPage() {
        Intent intent = new Intent(HomePage.this, MediaActivity.class);
        startActivity(intent);
    }
